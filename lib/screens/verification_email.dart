...
class OtpFormEmail extends StatefulWidget {
  const OtpFormEmail(
      {Key key,
        this.email,
})
  ...
  @override
  _OtpFormEmailState createState() =>
      _OtpFormEmailState(email);
}

class _OtpFormEmailState extends State<OtpFormEmail> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                                ...
                                onClick: () {
                                  if(veryficationcode.length == 4) {
                                   setState(() {
                                    ...
                                    PageManager.checkEmailRecover(email, veryficationcode,context).listen((val) {setState(() {
                                      _isLoaded=false;
                                    }); });
                    ...
                    GestureDetector(
                      onTap: () {
                        PageManager.emailRecover(email,context);
